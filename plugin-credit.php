<div style="background-color: #ff6600; max-width: 500px; text-align: center; padding: 20px; color: #fff;">
	...
	<img src="<?php echo(plugins_url('images/potent-logo.png', __FILE__)); ?>" alt="WP Zone" style="max-width: 100%;" />
	</a>
